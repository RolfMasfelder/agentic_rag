...
class DocumentRelation(models.Model):
    ...
    source_document = models.ForeignKey(Document, on_delete=models.CASCADE, related_name="relations_as_source")
    target_document = models.ForeignKey(Document, on_delete=models.CASCADE, related_name="relations_as_target")
